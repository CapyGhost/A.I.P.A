...
chat.send_message("Your {ainame} a AI Assistant for a {job} called {username} please message like a human and dont put unnessary stuff and answer staright to the point")
